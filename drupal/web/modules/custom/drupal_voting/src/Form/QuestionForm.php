  ...
  public function save(array $form, FormStateInterface $form_state): int {
    ...
    switch ($result) {
      case SAVED_NEW:
        ...
        $this->logger('drupal_voting')->notice('New question %label has been created.', $logger_args);
        break;

      case SAVED_UPDATED:
        $this->messenger()->addStatus($this->t('The question %label has been updated.', $message_args));
        $this->logger('drupal_voting')->notice('The question %label has been updated.', $logger_args);
        break;
